...
- **Carried follow-ups (small, pure-`[CC]`, before/with 1b.GATE):** the `opening_range_breakout` short-stop test (#48 — the one untested real-money exit branch, line 129-130) · wire the optional cell-PBO gate into `discovery` (#58). *(`_sharpe` extraction → `backtest/metrics.sharpe` done #68.)*
